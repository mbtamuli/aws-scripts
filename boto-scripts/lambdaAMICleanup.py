...
def lambda_handler(event, context):
    ...
    print("Found {} instances that need evaluated".format(len(instances)))
        ...
        for image in images:
            ...
            if image.name.startswith('Lambda - ' + instance['InstanceId']):
                ...
                if image.name.endswith(date_fmt):
                    ...
                    backupSuccess = True
                    print("Latest backup from {} was a success".format(date_fmt))

        print("instance {} has {} AMIs".format(instance['InstanceId'], str(imagecount)))
    ...
    if backupSuccess == True:
        ...
        for image in imagesList:
            print("deregistering image {}".format(image))
